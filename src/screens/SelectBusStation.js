...
await AsyncStorage.removeItem('favoriteStation');
Alert.alert('즐겨찾기가 해제되었습니다!');
} else {
setFavoriteStation(stationName);
await AsyncStorage.setItem('favoriteStation', stationName);
...
<TouchableOpacity
style={styles.button}
onPress={() => navigation.navigate('BusArrivalInfo', { stationName })}
>
...
<TouchableOpacity style={styles.complaintsIconButton} onPress={handleComplaints}>
